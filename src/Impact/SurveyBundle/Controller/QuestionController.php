...
use Impact\SurveyBundle\Entity\Question;
use Impact\SurveyBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ImpactSurveyBundle:Question')->findAll();
     ...
     * @Method("POST")
     * @Template("ImpactSurveyBundle:Question:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ImpactSurveyBundle:Question')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ImpactSurveyBundle:Question:edit.html.twig")
     */
